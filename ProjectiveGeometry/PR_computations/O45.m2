...
-- quartic/quintic forms.  But, modulo the GL(3)x Aut(E) action, it can be
-- brought into the following normal form.

--   X 	   [a_1*X^3+a_2*X^2*Y+a_3*X*Y^2+Y^3, a_4*X^4+a_5*X^3*Y+a_6*X^2*Y^2]
--   (X-Y) [b_1*X^3+b_2*X^2*Y+b_3*X*Y^2+b_4*Y^3, b_5*X^4+b_6*X^3*Y+b_7*X^2*Y^2+b_8*X*Y^3+Y^4]
--   (X-2Y)[c_1*X^3+c_2*X^2*Y+c_3*X*Y^2+Y^3, c_4*X^4+c_5*X^3*Y+c_6*X^2*Y^2+c_7*X*Y^3+Y^4]

A = k[a_1..a_6,b_1..b_8,c_1..c_7]
S = A[X,Y]
M = matrix ({{X*(a_1*X^3+a_2*X^2*Y+a_3*X*Y^2+Y^3), X*(a_4*X^4+a_5*X^3*Y+a_6*X^2*Y^2)},
    	     {(X-Y)*(b_1*X^3+b_2*X^2*Y+b_3*X*Y^2+b_4*Y^3), (X-Y)*(b_5*X^4+b_6*X^3*Y+b_7*X^2*Y^2+b_8*X*Y^3+Y^4)},	
    	     {(X-2*Y)*(c_1*X^3+c_2*X^2*Y+c_3*X*Y^2+Y^3), (X-2*Y)*(c_4*X^4+c_5*X^3*Y+c_6*X^2*Y^2+c_7*X*Y^3+Y^4)}})
...
monsSmaller = flatten entries gens (ideal(X,Y))^11
monsBigger = flatten entries gens (ideal(X,Y))^12
...
kXY = k[X,Y]
imSmaller = random(11,kXY)
imBigger = random(12, kXY)
monsSmaller = flatten entries gens (ideal(X,Y))^11
monsBigger = flatten entries gens (ideal(X,Y))^12
