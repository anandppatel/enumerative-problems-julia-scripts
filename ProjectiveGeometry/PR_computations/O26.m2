...
-- quadric/sextic forms.  But, modulo the GL(3)x Aut(E) action, it can
-- be brought into a normal form.

A = k[a_1,b_1..b_7,c_1..c_7]
S = A[X,Y]
M = matrix ({{X*(a_1*X+Y), X*(X^5)},
    	     {(X-Y)*(b_1*X+Y), (X-Y)*(b_2*X^5 + b_3*X^4*Y + b_4*X^3*Y^2 + b_5*X^2*Y^3 + b_6*X*Y^4 + b_7*Y^5)},	
    	     {(X-2*Y)*(c_1*X+Y), (X-2*Y)*(c_2*X^5 + c_3*X^4*Y + c_4*X^3*Y^2 + c_5*X^2*Y^3 + c_6*X*Y^4 + c_7*Y^5)}})
